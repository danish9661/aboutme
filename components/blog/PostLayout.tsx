        ...
        >
          {older ? (
            <Link
              ...
              className="group rounded-2xl border border-line bg-surface p-5 transition-all hover:-translate-y-0.5 hover:shadow-[0_18px_50px_-24px_rgba(124,58,237,0.4)] motion-reduce:hover:translate-y-0"
            >
          ...
          {newer && (
            <Link
              ...
              className="group rounded-2xl border border-line bg-surface p-5 text-right transition-all hover:-translate-y-0.5 hover:shadow-[0_18px_50px_-24px_rgba(124,58,237,0.4)] motion-reduce:hover:translate-y-0"
            >
              <span className="inline-flex items-center gap-1 font-mono text-[11px] uppercase tracking-[0.12em] text-ink-3">
                Newer
                <span
